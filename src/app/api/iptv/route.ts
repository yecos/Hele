...
const CUSTOM_CHANNELS_PREMIUM: IPTVChannel[] = [
  ...
  // ===== CANALES PREMIUM ADICIONALES DESDE IPTV-ORG (URLs verificadas) =====
  // Cine Premium - URLs verificadas desde iptv-org/LATAM playlist
  ...
  // Entretenimiento Premium adicional - URLs verificadas
  ...
  // Deportes Premium adicional - URLs verificadas desde iptv-org
  ...
  // Cultura Premium adicional - URL verificada
